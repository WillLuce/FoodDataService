...
namespace FoodDataService.Utils
{
    public static class ParamUtils
    {
        ...
        public static void CheckNullOrEmpty(this string s, string paramName = null, bool allowWhitespace = false)
        {
            ...
            var checkFunc = allowWhitespace ? (Func<string, bool>)String.IsNullOrEmpty : String.IsNullOrWhiteSpace;

            if (checkFunc(s))
            {
                throw new ArgumentException("String value required", paramName);
            }
        }
    }
}
